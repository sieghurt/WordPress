...
<div class="wrap">
  <div id="icon-plugins" class="icon32"></div>
	...
	<div class="tablenav bottom">
		<a href="<?php echo ELP_ADMINURL; ?>?page=elp-email-template"><input class="button button-primary" type="button" value="<?php _e('Back', 'email-posts-to-subscribers'); ?>" /></a>
		<a href="<?php echo ELP_ADMINURL; ?>?page=elp-email-template&ac=edit&did=<?php echo $did; ?>"><input class="button button-primary" type="button" value="<?php _e('Edit', 'email-posts-to-subscribers'); ?>" /></a>
