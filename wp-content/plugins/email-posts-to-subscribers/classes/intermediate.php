...
//				break;
//		}
		require_once(ELP_DIR.'sendmail'.DIRECTORY_SEPARATOR.'sendmail.php');
	}
	...
	public static function elp_settings()
	{
		...
		//}
		require_once(ELP_DIR.'settings'.DIRECTORY_SEPARATOR.'settings.php');
	}
	...
	public static function elp_postnotification()
	{
		...
		switch($current_page)
		{
			...
			case 'preview':
				...
				break;
			case 'queue':
				require_once(ELP_DIR.'notification'.DIRECTORY_SEPARATOR.'notification-queue.php');
				break;
			default:
	...
	public static function elp_options()
	{
		global $wpdb;
		$current_page = isset($_GET['ac']) ? $_GET['ac'] : '';
		switch($current_page)
		{
			case 'sync':
				require_once(ELP_DIR.'options'.DIRECTORY_SEPARATOR.'setting-sync.php');
				break;
			default:
				require_once(ELP_DIR.'options'.DIRECTORY_SEPARATOR.'options.php');
				break;
		}
