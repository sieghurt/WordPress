...
class Notice {
    ...
    public function set_dismiss_notice_callback() {
        ...
        set_transient( 'ultp_get_pro_notice_v13', 'off', 2592000 ); // 30 days notice
    }
    public function ultp_installation_notice_callback() {
        if (get_transient('ultp_get_pro_notice_v13') != 'off' && (!defined('ULTP_PRO_VER'))) {
            ...
            <div class="wc-install ultp-pro-notice">
                <div class="wc-install-body">
                    ...
                    <div><?php _e('Want to help make <b>PostX - Gutenberg Post Blocks</b> even more awesome? You can get up to <b style="color:#e5561e;">up to 40% Discount coupon</b> for all premium features.', 'ultimate-post'); ?></div>
