...
<div class="wrap">
	...
	<h1>WP Accessibility Helper. <span class="wah_slogan">"WordPress Accessibility made easy!"</span></h1>
		...
		<form name="oscimp_form" class="wah-main-admin-form clearfix" method="post" action="<?php echo esc_html( str_replace( '%7E', '~', $server_request_uri ) ); ?>">
			...
			<div class="wah_form_elements_wrapper">
				<div class="form_element_content">
					...
					<div class="wahpro-placeholder">
						<div class="pro-label">WAH PRO feature - Layout manager</div>
						<img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) ); ?>img/layout_icons.png" alt="Layout manager">
					</div>
			...
			<div class="wah_form_elements_wrapper">
				<div class="form_element_content">
					...
					<div class="wahpro-placeholder">
						<div class="pro-label">WAH PRO feature - Sepia and Monochrome</div>
						<img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) ); ?>img/sepia_monochrome.png" alt="Sepia & Monochrome">
					</div>
			...
			<div class="wah_form_elements_wrapper">
				<div class="form_element_content">
					...
					<div class="wahpro-placeholder">
						<div class="pro-label">WAH PRO feature - Large mouse cursor</div>
						<img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) ); ?>img/cursor.png" alt="Large mouse cursor link">
					</div>
				</div>
			</div>
			<hr />
			...
			<div class="wahpro-placeholder">
				<div class="pro-label">WAH PRO feature - Custom link/button</div>
				<img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) ); ?>img/customlink.png" alt="Custom link">
			</div>

			<div class="wahpro-placeholder">
				<div class="pro-label">WAH PRO feature - Advanced settings</div>
				<img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) ); ?>img/advsettings.png" alt="Advanced settings">
			</div>
