  ...
  public function start_lvl( &$output, $depth = 0, $args = array() ) {
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
      ...
      if ( 0 === strcasecmp( $item->attr_title, 'divider' ) && 1 === $depth ) {
        ...
        $class_names = join( ' ', apply_filters( 'trend_news_nav_menu_css_class', array_filter( $classes ), $item, $args, $depth ) );
      ...
      $id          = apply_filters( 'trend_news_nav_menu_item_id', 'menu-item-' . $item->ID, $item, $args );
      ...
      $atts       = apply_filters( 'trend_news_nav_menu_link_attributes', $atts, $item, $args );
      $attributes = '';
      ...
      $item_output = $args->before;
        ...
        $item_output .= $args->link_before . apply_filters( 'trend_news_the_title', $item->title, $item->ID ) . $args->link_after;
        $item_output .= ( $args->has_children && 0 === $depth ) ? '</a>' : '</a>';
        $item_output .= $args->after;
        $output      .= apply_filters( 'trend_news_walker_nav_menu_start_el', $item_output, $item, $depth, $args );
      } // End if().
    }
    /**
